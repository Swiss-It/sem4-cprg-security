...
export function LoginPage() {
    ...
    const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log('Login initiated via context...');
        } catch (error) {
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleLogin}>
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium text-black dark:text-black mb-1">
                                Email
                            </label>
                            <input
                                id="email"
                                ...
                                autoComplete="email"
                                required
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-black dark:text-black 
          placeholder:text-gray-400 dark:placeholder:text-gray-500"
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        >
                            ...
                            Login with Github
                            <svg width="28" height="28" viewBox="-60 0 160 140" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="github">
<g id="github_2">
